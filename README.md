...
https://github.com/Anymatix/anymatix-beta/releases/download/v1.0.0-beta.2/anymatix-1.0.0-beta.2-setup.exe
...
1. Click to download. **Do not open after download**:
	...
	https://github.com/Anymatix/anymatix-beta/releases/download/v1.0.0-beta.2/anymatix-1.0.0-beta.2-bundle.zip


2. **Open terminal and copy paste** (replace "Downloads" if you downloaded it in a different directory):
	```
	cd ~/Downloads && unzip -o anymatix-1.0.0-beta.2-bundle.zip && bash ./install.sh
	```
