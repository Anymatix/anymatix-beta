...
```
curl.exe -L --progress-bar "https://github.com/Anymatix/anymatix-beta/releases/download/v1.0.0-beta.7/anymatix-1.0.0-beta.7-setup.exe" -o "anymatix-1.0.0-beta.7-setup.exe"; Unblock-File "anymatix-1.0.0-beta.7-setup.exe"; .\anymatix-1.0.0-beta.7-setup.exe
```
